    ...
    if (window.TicketAPI && window.TicketAPI.replyToTicket) {
      window.TicketAPI.replyToTicket(ticketId, { body, subject, status })
        .then(() => {
          ...
          setTimeout(() => navigate('/doctor/tickets'), 1500);
        })
        .catch((err) => {
      ...
      <div className="detail-card">
        ...
        <div className="reply-list">
          <div className="reply-item">
            ...
            <div className="reply-text">Massage Text – previous reply content from the doctor.</div>
          </div>
          <div className="reply-item">
              ...
              <div className="status-dropdown" aria-expanded={statusOpen}>
                ...
                <ul className="status-dropdown-menu">
                  {statusOptions.map((opt) => (
                    <li
                      key={opt.value}
                      className={`status-dropdown-option ${opt.value === status ? 'selected' : ''}`}
